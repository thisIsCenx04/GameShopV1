        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdminFeeRate = table.Column<decimal>(type: "DECIMAL(5,4)", nullable: false),
                    InsuranceAmount = table.Column<decimal>(type: "DECIMAL(18,0)", nullable: false),
                    ContractStatus = table.Column<byte>(type: "tinyint", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CollaboratorContracts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CollaboratorContracts_Users_CollaboratorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisputeRate = table.Column<decimal>(type: "DECIMAL(5,4)", nullable: false, defaultValue: 0m),
                    ReputationScore = table.Column<decimal>(type: "DECIMAL(7,2)", nullable: false, defaultValue: 0m),
                    BadgeLevel = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "New"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CollaboratorStats", x => x.UserId);
                    table.ForeignKey(
                        name: "FK_CollaboratorStats_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CommissionRules_Games_GameId",
                        column: x => x.GameId,
                        principalTable: "Games",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_CommissionRules_Users_CollaboratorId",
                        column: x => x.CollaboratorId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InsuranceDeposits", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InsuranceDeposits_Users_CollaboratorId",
                        column: x => x.CollaboratorId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValueSql: "NEWID()"),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Balance = table.Column<decimal>(type: "DECIMAL(18,0)", nullable: false, defaultValue: 0m),
                    FrozenBalance = table.Column<decimal>(type: "DECIMAL(18,0)", nullable: false, defaultValue: 0m),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CollaboratorId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    GameId = table.Column<int>(type: "int", nullable: false),
                    GameRankId = table.Column<int>(type: "int", nullable: false),
                    GameServerId = table.Column<int>(type: "int", nullable: true),
                    Title = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductListings_GameRanks_GameRankId",
                        column: x => x.GameRankId,
                        principalTable: "GameRanks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductListings_GameServers_GameServerId",
                        column: x => x.GameServerId,
                        principalTable: "GameServers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_ProductListings_Games_GameId",
                        column: x => x.GameId,
                        principalTable: "Games",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductListings_Users_ApprovedById",
                        column: x => x.ApprovedById,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_ProductListings_Users_CollaboratorId",
                        column: x => x.CollaboratorId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Amount = table.Column<decimal>(type: "DECIMAL(18,0)", nullable: false),
                    BalanceAfter = table.Column<decimal>(type: "DECIMAL(18,0)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Amount = table.Column<decimal>(type: "DECIMAL(18,0)", nullable: false),
                    CollaboratorEarning = table.Column<decimal>(type: "DECIMAL(18,0)", nullable: false),
                    AdminFee = table.Column<decimal>(type: "DECIMAL(18,0)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_ProductListings_ListingId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductListingTags", x => new { x.ListingId, x.TagId });
                    table.ForeignKey(
                        name: "FK_ProductListingTags_ProductListings_ListingId",
                        column: x => x.ListingId,
                        principalTable: "ProductListings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductListingTags_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EncryptedUsername = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccountDeliveries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AccountDeliveries_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CommissionLedgers_Users_CollaboratorId",
                        column: x => x.CollaboratorId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountDeliveries_OrderId",
                table: "AccountDeliveries",
                column: "OrderId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CollaboratorContracts_CollaboratorId",
                table: "CollaboratorContracts",
                column: "CollaboratorId");

            migrationBuilder.CreateIndex(
                name: "IX_CommissionLedgers_CollaboratorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommissionRules_CollaboratorId",
                table: "CommissionRules",
                column: "CollaboratorId");

            migrationBuilder.CreateIndex(
                name: "IX_CommissionRules_GameId",
                table: "CommissionRules",
                column: "GameId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InsuranceDeposits_CollaboratorId",
                table: "InsuranceDeposits",
                column: "CollaboratorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductListings_ApprovedById",
                table: "ProductListings",
                column: "ApprovedById");

            migrationBuilder.CreateIndex(
                name: "IX_ProductListings_CollaboratorId",
                table: "ProductListings",
                column: "CollaboratorId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductListings_GameId",
                table: "ProductListings",
                column: "GameId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductListings_GameRankId",
                table: "ProductListings",
                column: "GameRankId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductListings_GameServerId",
                table: "ProductListings",
                column: "GameServerId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductListings_Status_GameId_Price",
                table: "ProductListings",
                columns: new[] { "Status", "GameId", "Price" });

            migrationBuilder.CreateIndex(
                name: "IX_ProductListingTags_TagId",
                table: "ProductListingTags",
                column: "TagId");
